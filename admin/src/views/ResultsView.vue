        ...
        <main class="main">
            ...
            <y-modal v-if="window === 'main'" class="main__modal">
                ...
                <div class="filters" v-if="filters.block_id">
                    ...
                    <button class="button" @click="statByWholeBlock()"
                            v-if="filters.week != null && filters.week != ''">По всему блоку
                    </button>
                    <button class="button" @click="statByGroup()"
                            v-if="filters.week != null && filters.week != '' && filters.group_id">По всей группе
                    </button>
                </div>
