    ...
    <article class="side_bar">
      <div class="col header-area">
        ...
        <nav class="side_bar__nav">
          <router-link to="/block" active-class="nav__link_active" class="link nav__link"><i class="fa-solid fa-list"></i> Блоки</router-link>
      ...
      <!--    <div></div>-->
      <nav class="side_bar__nav">
        <router-link @click="logout()" class="link nav__link exit" to="/"><i class="fa-solid fa-arrow-right-from-bracket"></i> Выйти</router-link>
      </nav>
    </article>
  </div>
</template>
