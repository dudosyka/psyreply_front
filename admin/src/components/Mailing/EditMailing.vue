<template>
  <y-modal class="modal">
    ...
    <y-modal>
      <header class="header">
        <h2 class="heading">Изменение параметров рассылки</h2>
      </header>
      ...
      <y-cool-button @click="updateBlock">Сохранить обновленную рассылку</y-cool-button>
    </y-modal>
    ...
    <y-modal>
      ...
      <y-cool-button @click="removeBlock">Удалить рассылку</y-cool-button>
    </y-modal>
